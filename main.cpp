...
private:
	...
	void initWindow() {
		...
		window = glfwCreateWindow(WIDTH, HEIGHT, "SFML", nullptr, nullptr);
	}
	...
	int rateDeviceSuitability(VkPhysicalDevice device) {
		...
		if(!checkDeviceEstensionSupport(device)){
			return -1;	
		}
	...
	bool checkDeviceEstensionSupport(VkPhysicalDevice device){
